...
![image](assets/img/correlation.PNG)
...
![image](assets/img/SimpsonParadox.PNG)
...
    p(y_1) &= \mathcal{N}(y_1 \mid \mu_1, \Sigma\_{11}), \\\[8pt\]

    p(y_2) &= \mathcal{N}(y_2 \mid \mu_2, \Sigma\_{22}),
...
    p(y_1 \mid y_2) &= \mathcal{N}(y_1 \mid \mu\_{1|2}, \Sigma\_{1|2}), \\\[8pt\]

    \mu\_{1|2} &= \mu_1 + \Sigma\_{12}\Sigma\_{22}^{-1}(y_2 - \mu_2), \\\[8pt\]
...
\\textrm{Var}!\Bigl\[y\_{n,i} \mid \mathbf{y}\_{n,v}, \theta\Bigr\]
...
    p(z \mid y) &= \mathcal{N}(z \mid \mu\_{z \mid y}, \Sigma\_{z \mid y}), \\\[8pt\]

    \Sigma\_{z \mid y}^{-1} &= \Sigma_z^{-1} + W^T,\Sigma_y^{-1},W, \\\[8pt\]

    \mu\_{z \mid y} &= \Sigma\_{z \mid y}\Bigl\[ W^T,\Sigma_y^{-1}(y - b) + \Sigma_z^{-1}\mu_z \Bigr\].
